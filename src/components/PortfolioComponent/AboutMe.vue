    ...
    <div class="container">
      <div class="about-grid">
        <div class="about-card">
          <img class="icon" src='https://doctoradham.com/blog/wp-content/uploads/2017/03/Dr-Adham-Farouk-Plastic-Surgery-Clinic-Alexandria-Egypt-Rhinoplasty-_02.jpg'>
          <h3>User Research</h3>
        </div>
        <div class="about-card">
          <h3>User Testing</h3>
        ...
        <div class="about-card st0 st1 st2">
            <svg class="icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="_x31__x2C_5"
      ...
      <div class="about-info">
        ...
        <h1 class="heading">Better design + Higher performance,<b>better experiences</b></h1>
        <p class="text">
          I am a mobile and website developer with 2 years experience, I love solving complex problems, with
          simple solutions and I like to spend most of my time working, developing my skills and learning.
        </p>
        <div class="cta">
          <a href="https://api.whatsapp.com/send/?phone=201114988434&text&type=phone_number&app_absent=0"
            class="btn">contact me</a>
          <a href="./assets/CV_laravel.pdf" download class="btn secondary-btn">Download CV</a>
        </div>
      </div>
    </div>
  </section>
