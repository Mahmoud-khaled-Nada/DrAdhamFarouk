        ...
        <section class="services section" id="services">
            ...
            <div class="container">
                <div class="services-info">
                    ...
                    <p class="text">
                      I make mobile applications and websites with high quality and fast performance in record time and at an affordable price
                    </p>
                ...
                <div class="services-grid">
                    <div class="srv-card">
                        <div class="card-desc">
                            <h3>E-commerce</h3>
                            <p class="text">
                              Create professional websites and applications for e-commerce.
                            </p>
                        </div>
                    ...
                    <div class="srv-card">
                        <div class="card-desc">
                            ...
                            <p class="text">
                              I can make systems such as accounts programs, ERP and other programs.
                            </p>
                        </div>
                        <!-- <a href="" class="btn secondary-btn">Explore More</a> -->
                    </div>
                    <div class="srv-card">
                        <div class="card-desc">
                            <h3>Mobile App</h3>
                            <p class="text">
                              I can make mobile applications that work on everything (Ios , Android)
                            </p>
                        </div>
                        <!-- <a href="" class="btn secondary-btn">Explore More</a> -->
                    </div>
                    <div class="srv-card">
                        <div class="card-desc">
                            <h3>App Desing</h3>
                            <p class="text">
                              In every project I work on, I choose the best design to take precedence over the competition
                            </p>
                        </div>
                        <!-- <a href="" class="btn secondary-btn">Explore More</a> -->
                    </div>
                    <img src="./assets/square1.png" class="shape square">
                </div>
            </div>
        </section>
</template>
